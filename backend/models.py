...
class AppConfig(Base):
    ...
    # Per-fallback base URL and API key (optional; falls back to primary if empty)
    fallback_2_base_url = Column(String(500), default="")
    fallback_2_api_key = Column(String(500), default="")
    fallback_3_base_url = Column(String(500), default="")
    fallback_3_api_key = Column(String(500), default="")
    fallback_3_model = Column(String(100), default="")
    fallback_4_base_url = Column(String(500), default="")
    fallback_4_api_key = Column(String(500), default="")
    fallback_4_model = Column(String(100), default="")
